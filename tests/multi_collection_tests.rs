...
fn two_collections_are_isolated() {
    ...
    s.create_collection("text".to_string(), "bge-m3".to_string(), 3, Some("Cosine".to_string()), None, None, None).unwrap();
...
fn dim_mismatch_is_rejected() {
    ...
    s.create_collection("code".to_string(), "m".to_string(), 4, None, None, None, None).unwrap();
...
fn collections_survive_snapshot_reload() {
    let path = fresh("test_mc_snapshot");
    {
        ...
        s.create_collection("code".to_string(), "jina-code".to_string(), 4, Some("Cosine".to_string()), None, None, None).unwrap();
...
fn wal_replay_recovers_custom_collection() {
    ...
    {
        let s = open_dim(&path, 4);
        s.create_collection("code".to_string(), "jina-code".to_string(), 4, None, None, None, None).unwrap();
