...
tags:
  ...
  - architecture
  - supersede
crosslinks: {"references":["FRAME--MSP-ARCHITECTURE-V2","FRAME--MSP-ARCHITECTURE","CONCEPT--OBSIDIAN-AS-RUNTIME","CONCEPT--EMBEDDING-STRATEGY","ADR--MSP-OBSIDIAN-INTEGRATION","ADR--SEMANTIC-SEARCH-VIA-SMART-CONNECTIONS"]}
linked_symbols: []
