...
export function stripLeadingCommentary(input) {
    const lines = input.split(/\r?\n/);
    let i = 0;
...
export function stripTrailingCommentary(input) {
    const lines = input.split(/\r?\n/);
    let last = -1;
...
export function normaliseLineEndings(input) {
