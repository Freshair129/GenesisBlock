 ...
 */
export function defaultKeepResult() {
    return {
        score: 0.6,
        summary: '',
        tags: [],
 ...
 */
export function buildTier2Prompt(chunk) {
    const body = chunk
 ...
 */
export function parseTier2Response(parsed) {
 ...
 */
export async function callTier2(chunk, opts = {}) {
    if (!opts.llm)
