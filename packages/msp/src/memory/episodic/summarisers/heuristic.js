...
export const heuristicSummariser = async (turns) => {
    ...
    if (decisions.length > 0)
        result.key_decisions = decisions.slice(0, 5);
    return result;
};
