...
import { CURRENT_SCHEMA_VERSION, DEFAULT_NAMESPACE, defaultIdentity, defaultProfile, defaultVoice, } from './types.js';
/**
 ...
 */
export function identityPath(root, namespace) {
 ...
 */
export function projectOverridePath(root, namespace) {
    return resolve(root, '.brain/msp/projects', namespace, 'identity.override.json');
}
/**
...
async function readJsonFile(path) {
    ...
    if (typeof parsed.schemaVersion === 'number' &&
        ...
        throw new Error(`identity file at ${path} has schemaVersion=${parsed.schemaVersion}; ` +
 ...
 */
async function readProjectOverride(root, namespace) {
 ...
 */
export async function writeIdentity(opts, identity) {
