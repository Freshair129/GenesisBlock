...
export { defaultIdentity, defaultProfile, defaultVoice, DEFAULT_NAMESPACE, CURRENT_SCHEMA_VERSION, } from './types.js';
// Sub-module surfaces
export { setProfile } from './profile.js';
export { setVoice } from './voice.js';
export { setPreference, getPreference, prunePreferences, } from './preferences.js';
// Low-level store (exposed for advanced callers / tests)
export { identityPath, projectOverridePath, readIdentity, resolveOptions, writeIdentity, } from './store.js';
