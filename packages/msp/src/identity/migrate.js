...
function legacyIdentityPath(root, namespace) {
 ...
 */
export async function migrateIfNeeded(workspaceRoot, namespace) {
    ...
    console.warn(`[msp] migrated workspace identity to global: ${source} → ${destination}. ` +
