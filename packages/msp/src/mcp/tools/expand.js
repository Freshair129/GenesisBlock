...
export const description = 'Expand an atom from MENTION to FULL resolution (UCF Phase 3). Returns the full body if permitted by policy.';
...
export function handler(ctx) {
    return async (args) => {
        try {
            ...
            return {
                content: [{ type: 'text', text: `expand failed: ${err.message}` }],
                isError: true,
            };
        }
    };
