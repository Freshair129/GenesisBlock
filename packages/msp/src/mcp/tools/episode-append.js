...
export const description = 'Append (or overwrite by episodicId) an episode in episodic_memory.json. Idempotent on episodicId.';
...
export function handler(ctx) {
    return async (args) => {
        ...
        try {
            ...
            return errorResult(`episode append failed: ${err.message}`);
        }
    };
}
