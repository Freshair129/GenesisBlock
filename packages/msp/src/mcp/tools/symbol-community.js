...
export const description = 'Resolve a symbol id to its Leiden community and return the community metadata + member list. Read-only.';
...
export function handler(ctx) {
    return async (args) => {
        ...
        try {
            ...
            return errorResult(`symbol_community failed: ${err.message}`);
        }
        finally {
            try {
                store.close();
