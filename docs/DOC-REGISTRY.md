...
| GenesisRAG17 integration ADR | `ADR-GENESISRAG17-SEPARATE-WORKER-PUBLICATION` | `1.0.2b` | beta | GenesisBlockDB Architecture | `docs/ADR--GENESISRAG17-SEPARATE-WORKER-PUBLICATION.md` |
| GenesisRAG17 execution flow | `FLOW-GENESISRAG17-PIPELINE` | `1.0.2b` | beta | GenesisBlockDB Architecture | `docs/FLOW--GENESISRAG17-PIPELINE.md` |
| GenesisRAG17 extension map | `MAP-GENESISRAG17-EXTENSIONS` | `1.0.2b` | beta | GenesisBlockDB Architecture | `docs/GENESISRAG17-EXTENSION-MAP.md` |
