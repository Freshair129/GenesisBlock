...
role: "Configurable HNSW ef + 3-way 100k benchmark (GenesisDB vs Chroma vs Qdrant)"
phase: 20
...
C: SSD. GenesisDB & Chroma are **embedded in-process**; Qdrant is **client-server**
...
- **Query latency: GenesisDB leads at scale.** p50 896–974 µs vs Chroma 990 µs;
...
- **Recall: GenesisDB ef=200 ≈ Chroma** (0.979 vs 0.981) — effectively parity.
...
- **Insert:** GenesisDB durable 1,751–1,982 vs Chroma non-durable 3,270 (~1.7×).
  Qdrant's 715 includes async index-build wait + gRPC; not a like-for-like
  embedded insert.

**Verdict:** at 100k GenesisDB is **query-latency-leading, recall-at-parity
