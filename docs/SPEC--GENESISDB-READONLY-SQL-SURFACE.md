...
last_update: "2026-08-29T23:55:00+07:00,Claude Opus 5"
status: proposed
superseded_by: null
attributes:
  doc_type: "spec"
...
## 9. คำถามที่ต้องการคำตอบก่อนเริ่ม

1. เห็นด้วยกับการ **ไม่** เปิด REST ใน slice แรกไหม
2. ยอมรับได้ไหมว่าผิวนี้อ่านได้ทั้งฐาน ไม่มีการแยกสิทธิ์
3. ขีดจำกัด 5 วิ / 10,000 แถว เหมาะกับงานจริงของคุณไหม
